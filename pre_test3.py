...
def put_time_tag():
    visit = pd.read_hdf('visit_day_test.h5')
    ...
    del visit['month']
    del visit['day']
    visit.to_hdf('visit_day_test_new.h5',mode='w',key='tt',complevel=6,complib='blosc')
...
def get_train_features():
    ...
    features.to_csv('test_feature3.csv',index=False)
